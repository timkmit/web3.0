          ...
          <div className='flex flex-1 justify-start flex-col mf:mr-10'>
            <h1 className='text-3xl sm:text-5xl text-white text-gradient py-1'>
              ...
              <p className='text-left mt-5 text-white font-light md:w-9/12 w-11/12 text-base'>
                Explore the crypto world. Buy and sell cryptocurrencies easily on web3.0
              </p>
            ...
            <button 
              ...
              >
               <p className="text-gradient py-1 text-white text-base font-semibold">
                Connect Wallet
              </p>
              </button>

              <div className='grid sm:grig-cols-3 grid-cols-3 w-full mt-10'>
